import { AboutPagesDataType, CapabilitiesPagesDataType, IndustriesPagesDataType, LifeProcedureDataType } from "./types";

export const capabilitiesPagesData: { [key: string]: CapabilitiesPagesDataType } = {
  "digital-ventures": {
    heroSection: {
